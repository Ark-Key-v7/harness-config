...
description: "Records decisions and documentation: ADRs, README, API docs, changelog, inline why-comments. Use when making an architectural decision, changing a public API, or shipping user-facing behavior. Discipline class — binds to the worker seat."
metadata:
  author: Agentic SWE Factory
  trigger_phrases: ["write an ADR", "document this decision", "changelog", "API docs", "README"]
  class: discipline
  version: 1.0.0
...
- **Manifold files (.tmd/) and AGENTS.md** — project conventions live in the manifold as compiled law; agents obey `.tmd/` — human authorship only, agents never edit the baseline
