...
Stored in the project's spec directory: record where this project actually keeps specs (`specs/` on a governed rig project — the intent/PRD/plan chain under `specs/`; `docs/specs/` with `NNNN-title.md` elsewhere) and link what exists.
