...
metadata:
  ...
  version: 1.0.0
  class: discipline
  trigger_phrases: ["build a component", "new page", "accessible UI", "responsive layout", "fix the UI", "looks AI-generated"]
disable-model-invocation: true
provenance:
  source: addyosmani/agent-skills skills/frontend-ui-engineering
  imported: 2026-09-12
  edits: [E1 frontmatter+name, E2 references path, E3 metadata.class+trigger_phrases per IMPORT MODE step 4, E4 When NOT to Use per IMPORT MODE step 5]
---
...
- Backend-only changes (APIs, schemas, infra) with no user-facing surface.
- A governed product repo whose `.tmd/` law or design system already rules the question — the manifold wins (read it first; cite it, never restate it).
- Pure code review or audit lanes — this is a building discipline, not a review seat.
...
For detailed accessibility requirements and testing tools, see `references/accessibility-checklist.md` in this skill directory.
