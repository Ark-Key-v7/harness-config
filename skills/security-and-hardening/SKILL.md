...
description: "Prevention-time security discipline: STRIDE, three-tier boundary, OWASP patterns, secrets and supply-chain hygiene. Use when writing or reviewing any code that handles input, auth, secrets, dependencies, or destructive operations. Discipline class — binds to the worker seat; its Security Review Checklist is a reviewer-seat lens."
metadata:
  author: Agentic SWE Factory
  trigger_phrases: ["security review", "hardening", "STRIDE", "secrets hygiene", "input handling"]
  class: discipline
  version: 1.0.0
