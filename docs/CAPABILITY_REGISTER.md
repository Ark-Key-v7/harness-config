...
- **Status: Phase 1 LANDED 2026-09-21** — pinned clone; lint-skills v2.1.0 (byte budgets 32KB/24KB, description 400-char ratchet WARN, model-alias spawn-directive ban, contract-block byte-identity + unclosed-marker detection; dash/hyphen bans DECLINED per WP-F §7); skills-smoke extended to 18 checks, green. Phases 2–5 PENDING.
